...
<aside class="sidebar card-white">
  ...
  <sec:authorize access="hasRole('ROLE_ADMIN')">
   ...
   <sec:authorize access="hasRole('ROLE_PROFESSOR')">
      <li><a href="<c:url value='/professor-timetable'/>">내 강의 시간표</a></li>
      <li><a href="<c:url value='/grade-input'/>">성적 입력</a></li>
      <li><a href="<c:url value='/course-manage'/>">강좌 관리</a></li>
      <li><a href="<c:url value='/graduation-review'/>">졸업 심사</a></li>
    </sec:authorize>

    <!-- ✅ 학생 메뉴 -->
    <sec:authorize access="hasRole('ROLE_STUDENT')">
      <li><a href="<c:url value='/enrollment'/>">수강 신청</a></li>
      <li><a href="<c:url value='/student-timetable'/>">내 시간표</a></li>
